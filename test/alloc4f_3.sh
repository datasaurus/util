...
#-	Its test program is similar to the one in alloc4f_1.sh, except
#-	that it tests a small, one by one by one by one, array.
#-
...
#
# $Id: alloc4f_3.sh,v 1.10 2008/12/17 05:26:34 gcarrie Exp $
#
########################################################################
